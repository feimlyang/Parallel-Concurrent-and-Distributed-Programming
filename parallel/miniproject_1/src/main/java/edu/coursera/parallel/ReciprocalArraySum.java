...
public final class ReciprocalArraySum {
    ...
    protected static double parArraySum(final double[] input) {
        ...
        ReciprocalArraySumTask sumTask = new ReciprocalArraySumTask(0, input.length / 2, input);
        sumTask.fork();
    ...
    protected static double parManyTaskArraySum(final double[] input,
            final int numTasks) {
        ReciprocalArraySumTask[] sumTasks = new ReciprocalArraySumTask[numTasks - 1];
        for (int i = 0; i < sumTasks.length; i++) {
            ...
            sumTasks[i] = new ReciprocalArraySumTask(startIndex, endIndex, input);
            sumTasks[i].fork();
        }
